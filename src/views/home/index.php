...
<head>
    ...
    <script src="src/assets/js/eventos.js" defer></script>
    <!-- Font Awesome -->
                ...
                <div class="info">
                    <div class="user">
                        <div class="profile-pic">
                            <img class="rounded-circle" src="public/img/photos/<?php echo $p->getUser()->getProfile() ?>" alt="imgPerfil" width="50%">
                        </div>
                        <a class="username" href="/SkylAb-170/InstagramPhp/<?php echo $p->getUser()->getUsername() ?>">
                            <?php echo $p->getUser()->getUsername() ?>
                        </a>
                    </div>
                </div>
                <article class="articlee">
                    <img id="imgFondo" src="public/img/photos/<?php echo $p->getImage() ?>" class="post-image" alt="">
                    <img class="imgLike" src="src/assets/img/like.PNG" alt="">
                </article>
